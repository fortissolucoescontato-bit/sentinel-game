...
export const THEMES: Record<ThemeId, ThemeConfig> = {
    dracula: {
        id: "dracula",
        name: "Dracula",
        description: "Standard issued terminal theme. Reliable and clean.",
        priceCredits: 0,
        priceStylePoints: 0,
        cssVars: {
    ...
    matrix: {
        id: "matrix",
        name: "The Construct",
        description: "Classic green phosphor. Wake up, Neo.",
        priceCredits: 500,
        priceStylePoints: 0,
        cssVars: {
    ...
    synthwave: {
        id: "synthwave",
        name: "Neon Nights",
        description: "Retro-futuristic vibes with hot pink and cyan.",
        priceCredits: 1000,
        priceStylePoints: 0,
        cssVars: {
    ...
    amber: {
        id: "amber",
        name: "Fallout Retro",
        description: "Old-school monochrome amber monitor.",
        priceCredits: 0,
    ...
    crimson: {
        id: "crimson",
        name: "Red Alert",
        description: "Aggressive red theme for elite hackers.",
        priceCredits: 2000,
