...
import { getTopHackers, getDashboardStats, getUserRank } from "@/actions/leaderboard";
            ...
            <div className="relative z-10 container mx-auto px-4 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-slate-400 font-mono text-sm flex items-center gap-2">
                        ...
                        Estatísticas de hacking em tempo real e leaderboard
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-lg p-6 flex flex-col justify-center">
                        <h3 className="text-sm font-mono text-cyan-400 mb-4 text-center">CENTRO DE COMANDO</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="space-y-6">
                        <div className="bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-lg p-6">
                            <h3 className="text-sm font-mono text-cyan-400 mb-4">SEU RANKING</h3>
                            <div className="text-center">
                                ...
                                <p className="text-xs text-slate-500 font-mono">
                                    Continue hackeando para subir de nível!
                                </p>
                            </div>
                        </div>
                    </div>
