            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="mb-12 text-center">
                    ...
                    <p className="text-slate-400 font-mono">
                        The elite of the Sentinel Network. Hackers and Architects.
                    </p>
                </div>
                            ...
                            <Table>
                                <TableHeader className="bg-slate-950/50">
                                    <TableRow className="border-slate-800">
                                        ...
                                        <TableHead className="text-right text-slate-400">NET WORTH</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                        ...
                        <CardContent>
                            <Table>
                                <TableHeader className="bg-slate-950/50">
                                    <TableRow className="border-slate-800">
                                        <TableHead className="w-16 text-center text-slate-500">RANK</TableHead>
                                        <TableHead className="text-slate-400">ARCHITECT</TableHead>
                                        <TableHead className="text-right text-slate-400">BLOCKED ATTACKS</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                    {topDefenders.length === 0 ? (
                                        <TableRow>
                                            <TableCell colSpan={3} className="text-center text-slate-500 py-8 font-mono">
                                                No defensive data yet. Be the first to defend!
                                            </TableCell>
                                        </TableRow>
                                    ) : (
