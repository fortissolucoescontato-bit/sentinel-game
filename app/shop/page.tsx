                ...
                <div className="flex items-center justify-between mb-12">
                    <div>
                        ...
                        <p className="text-slate-400 font-mono text-sm">
                            Personalize sua interface neural. Aviso: Estilo é tudo.
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-6 bg-slate-900 border border-slate-800 px-6 py-3 rounded-lg">
                        <div className="text-right">
                            <div className="text-xs text-slate-500 font-mono">CRÉDITOS DISPONÍVEIS</div>
                        ...
                        <div className="text-right">
                            <div className="text-xs text-slate-500 font-mono">PONTOS DE ESTILO</div>
